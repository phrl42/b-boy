...
namespace GBC
{
 ...
 enum State
  ...
  struct CPU
  {
    ...
    inline uint8_t HALT(uint16_t *dest_register, IMode w, uint16_t *src_value, IMode r){}
    inline uint8_t STOP(uint16_t *dest_register, IMode w, uint16_t *src_value, IMode r){}
  ...
  private:
	...
	{"RST $20", 16, &CPU::RST, IMode::NONE, (uint16_t*)20, IMode::NONE, nullptr}, //0xE7
	...
	{"RST $28", 16, &CPU::RST, IMode::NONE, (uint16_t*)28, IMode::NONE, nullptr}, //0xEF
	...
	{"RST $38", 16, &CPU::RST, IMode::NONE, (uint16_t*)38, IMode::NONE, nullptr} //0xFF
      };
