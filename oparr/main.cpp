...
int main()
{
  ...
  for(int y = 0; y <= 15; y++)
  {
	...
	if(operand1 == "C") line += "IMode::NONE, Jump::C";
	if(operand1 == "NC") line += "IMode::NONE, Jump::NC";
	if(operand1 == "Z") line += "IMode::NONE, Jump::Z";
	if(operand1 == "NZ") line += "IMode::NONE, Jump::NZ";
	...
	line += "nullptr, IMode::NONE, nullptr, IMode::NONE, nullptr";
      ...
      if(line.size() < 20)
      {
	line += "&" + mnemonic + ", IMode::NONE, nullptr, IMode::NONE, nullptr";
      }
